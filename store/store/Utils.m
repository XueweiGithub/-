...
{
    NSString *passwordRegex = @"^(?=(((.*)[0-9]+(.*)[a-zA-z]+(.*))|((.*)[a-zA-z]+(.*)[0-9]+(.*)))$)[0-9A-Za-z~!@#$%^&*()_+-=]{6,11}$";
    // NSString *passwordRegex = @"^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,11}$";
...
+(NSString *)combinationUrl:(NSString *)imgUrl imgSize:(NSString *)imgSize{
    ...
    return [NSString stringWithFormat:@"%@?imageMogr2/auto-orient/thumbnail/%@!/strip/quality/50/format/jpg/interlace/1",imgUrl,imgSize];
}
...
+(NSString *)indexCombinationUrl:(NSString *)imgUrl imgSize:(NSString *)imgSize{
    ...
    return [NSString stringWithFormat:@"%@?imageMogr2/auto-orient/thumbnail/%@!/strip/quality/100/format/png/interlace/1",imgUrl,imgSize];
}
